...
class Motor
{
  public:
    ...
    const int PPS_MIN = 100;
    const int PPS_MAX = 600;
    
  private:
    const unsigned long  MICROSEC_MIN = (1000 / PPS_MAX) * 1000;
    const unsigned long  MICROSEC_MAX = (1000 / PPS_MIN) * 1000;
    const unsigned long  MICROSEC_ERR = 10000 * 1000; //1ステップ当りのμsecのエラー値
