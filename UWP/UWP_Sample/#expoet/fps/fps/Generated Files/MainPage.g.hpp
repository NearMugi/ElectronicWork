...
void ::fps::MainPage::InitializeComponent()
{
    if (_contentLoaded)
    {
        return;
...
void ::fps::MainPage::Connect(int __connectionId, ::Platform::Object^ __target)
{
...
::Windows::UI::Xaml::Markup::IComponentConnector^ ::fps::MainPage::GetBindingConnector(int __connectionId, ::Platform::Object^ __target)
{
